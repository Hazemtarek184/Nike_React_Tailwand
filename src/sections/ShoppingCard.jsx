...
const ShoppingCard = () => {
    ...
    return (
        <section className="padding max-container dark:bg-slate-950 flex max-md:flex-col ">
            {buyProducts.length == 0
                ...
                <div className="dark:text-white flex flex-col w-full text-center lg:text-3xl md:text-2xl sm:text-lg leading-normal font-semibold font-palanquin text-ellipsis">
                    ...
                    <div className="mt-4">
                        <Link className="text-coral-red hover:text-red-600" to="/products">Click Here </Link>
